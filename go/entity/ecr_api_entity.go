...
type EcrApiEntity struct {
	name    string
	client  *core.BluefinTecsEcrSDK
...
func NewEcrApiEntity(client *core.BluefinTecsEcrSDK, entopts map[string]any) *EcrApiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EcrApiEntity) GetName() string { return e.name }
...
func (e *EcrApiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EcrApiEntity) Deleted() bool {
	return e.deleted
}


func (e *EcrApiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEcrApiEntity(e.client, opts)
}

func (e *EcrApiEntity) Data(args ...any) any {
...
func (e *EcrApiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EcrApi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EcrApiEntity) DataTyped(data ...EcrApi) EcrApi {
	if len(data) > 0 {
		return typedFrom[EcrApi](e.Data(asMap(data[0])))
	}
	return typedFrom[EcrApi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EcrApi (all fields
// optional at the wire level).
func (e *EcrApiEntity) MatchTyped(match ...EcrApi) EcrApi {
	if len(match) > 0 {
		return typedFrom[EcrApi](e.Match(asMap(match[0])))
	}
	return typedFrom[EcrApi](e.Match())
}
...
func (e *EcrApiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EcrApiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EcrApiLoadMatch and returns an EcrApi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EcrApiEntity) LoadTyped(reqmatch EcrApiLoadMatch, ctrl map[string]any) (EcrApi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EcrApi{}, err
	}
	return typedFrom[EcrApi](res), nil
}



func (e *EcrApiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EcrApiEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EcrApiCreateData and returns an EcrApi. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EcrApiEntity) CreateTyped(reqdata EcrApiCreateData, ctrl map[string]any) (EcrApi, error) {
...
func (e *EcrApiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EcrApiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EcrApiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

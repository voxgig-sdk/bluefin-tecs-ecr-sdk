// EcrApi entity client (generated). Shared entity runtime (data/match
...
class EcrApiEntity : public EntityBase {
public:
  EcrApiEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("ecr_api", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EcrApiEntity>(this->client, opts);
  }

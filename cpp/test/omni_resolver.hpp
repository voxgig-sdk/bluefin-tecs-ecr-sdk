// BluefinTecsEcr SDK — the corpus test runner: vendored @voxgig/omni driven
...
//    state (a CtxPtr, a live BluefinTecsEcrSDK, an Injector closure) never
...
inline std::shared_ptr<::omni::Provider> sdk_provider(std::shared_ptr<BluefinTecsEcrSDK> client);
...
public:
  ...
  Run(const ::omni::RunPack& pack, std::shared_ptr<BluefinTecsEcrSDK> client_)
...
class NamedRunner {
public:
  NamedRunner(const ::omni::Runner& runner, std::shared_ptr<BluefinTecsEcrSDK> client)
...
private:
  ::omni::Runner runner_;
  std::shared_ptr<BluefinTecsEcrSDK> client_;
};
...
inline std::shared_ptr<::omni::Provider> sdk_provider(std::shared_ptr<BluefinTecsEcrSDK> client) {
  ...
  provider->client = [](const Json& options) -> std::shared_ptr<::omni::Provider> {
    ...
    return sdk_provider(BluefinTecsEcrSDK::testSDK(Value::undef(), opts));
  };
 ...
 */
inline NamedRunner makeRunner(const std::string& path, std::shared_ptr<BluefinTecsEcrSDK> client) {
 ...
 */
inline NamedRunner makeRunnerSpec(const Value& spec, std::shared_ptr<BluefinTecsEcrSDK> client) {
 ...
 */
inline CtxPtr omni_ctx(const Value& arg, std::shared_ptr<BluefinTecsEcrSDK> client,
                       UtilityPtr utility) {

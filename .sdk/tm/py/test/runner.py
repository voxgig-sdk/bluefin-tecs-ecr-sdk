...
class BluefinTecsEcrTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BluefinTecsEcrTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = BluefinTecsEcrTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = BluefinTecsEcrTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

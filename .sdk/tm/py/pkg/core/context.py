...
from projectname_sdk.core.control import BluefinTecsEcrControl
...
class BluefinTecsEcrContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinTecsEcrControl()
        ...
        if isinstance(sp, BluefinTecsEcrSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinTecsEcrResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinTecsEcrResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinTecsEcrOperation({})
    ...
    def make_error(self, code, msg):
        return BluefinTecsEcrError(code, msg, self)

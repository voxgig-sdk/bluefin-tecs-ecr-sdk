# BluefinTecsEcr SDK corpus test runner: the vendored @voxgig/omni engine driven
...
# and tm/swift/Tests/BluefinTecsEcrSDKTests/OmniResolver.swift.
#
...
defmodule BluefinTecsEcr.Omni do
  ...
  defp sdkprovider(client) do
    utility = BluefinTecsEcr.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(BluefinTecsEcr.test(nil, tostruct(options))) end,
  ...
  def errify(%BluefinTecsEcr.Error{} = err) do

...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private static func primaryRun() throws -> OmniResolver.Run {
    ...
    let run = try OmniResolver.makeRunner(
      SdkRunner.testJsonPath(), BluefinTecsEcrSDK.testSDK(nil, nil))("primary")
    RUN = run
    return run
  }

  // XCTestCase has no custom init; set these up per test.
  private var client: BluefinTecsEcrSDK!
  private var utility: Utility!

  override func setUp() {
    super.setUp()
    client = BluefinTecsEcrSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: BluefinTecsEcrSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: BluefinTecsEcrSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = BluefinTecsEcrSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = BluefinTecsEcrSDK.testSDK(nil, nil)
  ...
  func testExtendOptionInstallsAndInitialisesTheFeature() {
    ...
    let client = BluefinTecsEcrSDK.testSDK(nil, opts)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = BluefinTecsEcrSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = BluefinTecsEcrSDK(opts)
  ...
  func testMakeSpecBasic() throws {
    ...
    let specClient = BluefinTecsEcrSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() throws {
    ...
    let authClient = BluefinTecsEcrSDK.testSDK(nil, setupOpts)

...
static Context* corpus_ctx(BluefinTecsEcrSDK* cl, voxgig_value* ctxmap) {
  CtxSpec cs;
...
static void runset(const char* name, BluefinTecsEcrSDK* cl,
                        ctxfn cf, argfn af) {
...
static BluefinTecsEcrSDK* SHARED = NULL;
...
static BluefinTecsEcrSDK* client_for(const char* section) {

...
// ---- SDK client-base generic helpers (Main.fragment BluefinTecsEcrSDK) -------
...
voxgig_value* sdk_options_map(BluefinTecsEcrSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinTecsEcrSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinTecsEcrSDK* sdk) { return sdk->rootctx; }

...
// BluefinTecsEcr SDK clienttrack feature
...
class BluefinTecsEcrClienttrackFeature extends BluefinTecsEcrBaseFeature
{
    ...
    public function PostConstruct(BluefinTecsEcrContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinTecsEcr-SDK';

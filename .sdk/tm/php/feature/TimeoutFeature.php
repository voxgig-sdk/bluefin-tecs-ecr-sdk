...
// BluefinTecsEcr SDK timeout feature
...
class BluefinTecsEcrTimeoutFeature extends BluefinTecsEcrBaseFeature
{
    ...
    private function _with_timeout(BluefinTecsEcrContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinTecsEcrContext $_ctx, float $ms): void
    {
        $client = $this->client;

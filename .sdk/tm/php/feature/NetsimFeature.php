...
// BluefinTecsEcr SDK netsim feature
...
class BluefinTecsEcrNetsimFeature extends BluefinTecsEcrBaseFeature
{
    ...
    private function _simulate(BluefinTecsEcrContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinTecsEcrContext $ctx, array $applied): void
    {
        $client = $this->client;

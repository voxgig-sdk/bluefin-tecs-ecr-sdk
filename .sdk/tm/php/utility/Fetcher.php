...
class BluefinTecsEcrFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinTecsEcrSDK/1.0)';
    ...
    public static function call(BluefinTecsEcrContext $ctx, string $fullurl, array $fetchdef): array
    {

...
// BluefinTecsEcr SDK feature test
//
...
class FtCtrl extends BluefinTecsEcrControl
{
...
class FtClient
{
    ...
    private BluefinTecsEcrUtility $utility;

    public function __construct(BluefinTecsEcrUtility $utility, array $options)
    {
    ...
    public function get_utility(): BluefinTecsEcrUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (BluefinTecsEcrContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public BluefinTecsEcrContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (BluefinTecsEcrContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = BluefinTecsEcrConfig::make_feature($name);
    ...
    private static function buildUrl(BluefinTecsEcrSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof BluefinTecsEcrError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new BluefinTecsEcrResponse($fetched);
        }
    ...
    private function fail(BluefinTecsEcrContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (BluefinTecsEcrContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;

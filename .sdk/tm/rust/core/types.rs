...
pub trait BluefinTecsEcrEntity: Entity {
    fn load(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsEcrError>;
    fn list(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsEcrError>;
    fn create(&self, reqdata: Value, ctrl: Value) -> Result<Value, BluefinTecsEcrError>;
    fn update(&self, reqdata: Value, ctrl: Value) -> Result<Value, BluefinTecsEcrError>;
    fn remove(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsEcrError>;
}

// Shared Value helpers for the BluefinTecsEcr SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinTecsEcrEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinTecsEcrError {
    BluefinTecsEcrError::new(
        "unsupported_op",
        &format!(

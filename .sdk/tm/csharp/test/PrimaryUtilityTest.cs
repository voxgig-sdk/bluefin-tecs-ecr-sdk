...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinTecsEcrSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinTecsEcrSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinTecsEcrSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinTecsEcrSDK client, Utility utility)
    {

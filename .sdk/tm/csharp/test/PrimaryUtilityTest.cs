...
public class PrimaryUtilityTest
{
    ...
    private static OmniResolver.Run Run()
    {
        lock (RunLock)
        {
            if (RUN == null)
            {
                CLIENT = BluefinTecsEcrSDK.TestSDK(null, null);
    ...
    private static BluefinTecsEcrSDK GetClient()
    {
        Run();
        return CLIENT!;
    }
    ...
    private static Context MakeTestCtx(BluefinTecsEcrSDK client, Utility utility,
    ...
    private static Context MakeTestFullCtx(BluefinTecsEcrSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinTecsEcrSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinTecsEcrSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinTecsEcrSDK(new Dictionary<string, object?>
        {
            ["base"] = "http://localhost:8080",
            ["system"] = new Dictionary<string, object?>
            {
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinTecsEcrSDK.TestSDK(null, setupOpts);
    ...
    // BluefinTecsEcrError. The corpus says `match: out: code` for both, so
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinTecsEcrSDK.TestSDK(null, setupOpts);

...
internal static class Fh
{
    ...
    {
        return err is BluefinTecsEcrError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinTecsEcrSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinTecsEcrSdk.Helpers.ToInt(paging["totalCount"]));

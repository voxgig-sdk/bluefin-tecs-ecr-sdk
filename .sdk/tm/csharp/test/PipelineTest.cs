...
public class PipelineTest
{
    ...
    private static (BluefinTecsEcrSDK, Utility) PlClient(Dictionary<string, object?>? sdkopts)
    {
        var client = BluefinTecsEcrSDK.TestSDK(null, sdkopts);
        return (client, client.GetUtility());
    }

    private static Context PlCtx(BluefinTecsEcrSDK client, Utility utility,
    ...
    private class PlEntity : IEntity
    {
        ...
        // BluefinTecsEcrEntityBase: `remove` marks the instance, which keeps the
    ...
    private static Utility UtilWith(BluefinTecsEcrSDK client, FetcherFunc fetcher)
    {
    ...
    public void MakeRequestTransportErrorCarriedOnResponse()
    {
        ...
        Assert.True(resp.Err is BluefinTecsEcrError pe && pe.Code == "boom",

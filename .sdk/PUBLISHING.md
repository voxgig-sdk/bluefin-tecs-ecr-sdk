...
|---|---|---|
| `js/` | @voxgig-sdk/bluefin-tecs-ecr-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/bluefin-tecs-ecr | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bluefin-tecs-ecr-js \
      --repository voxgig-sdk/bluefin-tecs-ecr-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bluefin-tecs-ecr-js` shows it, and
`npm trust revoke @voxgig-sdk/bluefin-tecs-ecr-js --id=<id>` removes it.

// BluefinTecsEcrError: the SDK error type (mirrors go core/error.go / the rust
...
pub const BluefinTecsEcrError = struct {
    sdk: []const u8 = "BluefinTecsEcr",
    code: []const u8,
    msg: []const u8,
    ...
    pub fn make(code: []const u8, msg: []const u8) *BluefinTecsEcrError {
        const e = mem.a().create(BluefinTecsEcrError) catch unreachable;
        e.* = .{ .sdk = "BluefinTecsEcr", .code = code, .msg = msg };
        return e;
    }
};

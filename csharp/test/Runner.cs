// BluefinTecsEcr SDK test-runner SUPPORT (vendor-tag rollout): env overrides,
...
{
    public BluefinTecsEcrSDK Client = null!;
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFIN_TECS_ECR_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFIN_TECS_ECR_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFIN_TECS_ECR_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinTecsEcrSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        BluefinTecsEcrSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinTecsEcrError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, BluefinTecsEcrSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinTecsEcrError(code, msg, null);
    }

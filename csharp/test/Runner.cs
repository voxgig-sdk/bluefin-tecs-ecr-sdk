...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFINTECSECR_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFINTECSECR_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFINTECSECR_TEST_EXPLAIN");

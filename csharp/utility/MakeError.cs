// BluefinTecsEcr SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinTecsEcrError unless the per-call ctrl
// disables throwing (ctrl.throw == false), in which case it returns the
// (possibly nil) result data instead.

namespace BluefinTecsEcrSdk.Util;
...
public static partial class SdkUtility
{
    internal static object? MakeErrorUtil(Context ctx, Exception? err)
    {
        ...
        var msg = "BluefinTecsEcrSDK: " + opname + ": " + errmsg;
        ...
        var sdkErr = new BluefinTecsEcrError(
            err is BluefinTecsEcrError se ? se.Code : "", msg, ctx)
        {

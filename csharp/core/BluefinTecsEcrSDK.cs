...
using BluefinTecsEcrSdk.Feature;

namespace BluefinTecsEcrSdk;

public class BluefinTecsEcrSDK
{
    ...
    public BluefinTecsEcrSDK(Dictionary<string, object?>? options = null)
    {
        ...
        var config = global::BluefinTecsEcrSdk.SdkConfig.SharedConfig();
        ...
        // the chain.
        var featureOpts = global::BluefinTecsEcrSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(_options, "feature"))
        ...
        foreach (var fnameObj in featureOrder)
        {
            ...
            var fopts = global::BluefinTecsEcrSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(featureOpts, fname));
            if (fopts != null &&
                fopts.TryGetValue("active", out var active) &&
                active is bool ab && ab)
            {
                _utility.FeatureAdd(_rootctx, global::BluefinTecsEcrSdk.SdkConfig.MakeFeature(fname));
            }
        }
    ...
    {
        return global::BluefinTecsEcrSdk.Utility.Copy(_utility);
    }
    ...
    public Dictionary<string, object?> Prepare(Dictionary<string, object?>? fetchargs)
    {
        ...
        var ctrl = global::BluefinTecsEcrSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "ctrl"))
            ?? new Dictionary<string, object?>();
        ...
        var pathParams = global::BluefinTecsEcrSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "params"))
            ?? new Dictionary<string, object?>();
        var query = global::BluefinTecsEcrSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "query"))
            ?? new Dictionary<string, object?>();
    ...
    private Dictionary<string, object?> OpDenied(string op)
    {
        ...
        {
            ["ok"] = false,
            ["err"] = new Exception("BluefinTecsEcrSDK: " + op +
    ...
    private Dictionary<string, object?> RawRequest(Dictionary<string, object?>? fetchargs)
    {
        ...
        {
            var status = global::BluefinTecsEcrSdk.Helpers.ToInt(global::Voxgig.Struct.StructUtils.GetProp(fm, "status"));
        ...
        Dictionary<string, object?>? ctrl = null)
    {
        ...
        if (null != errors && 0 < errors.Count)
        {
            ...
            res["ok"] = false;
            res["err"] = new Exception("BluefinTecsEcrSDK: graphql: " + msg);
            res["graphql"] = errors;
        }
    ...
    // Idiomatic usage: client.EcrApi().List(null) or
    // client.EcrApi().Load(new() { ["id"] = ... }).
    public BluefinTecsEcrEntityBase EcrApi(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinTecsEcrSdk.Entity.EcrApiEntity(this, entopts);
    }


    public static BluefinTecsEcrSDK TestSDK(Dictionary<string, object?>? testopts,
        Dictionary<string, object?>? sdkopts)
    {
        ...
        var sdk = new BluefinTecsEcrSDK(sdkopts)
        {
            Mode = "test",
        };

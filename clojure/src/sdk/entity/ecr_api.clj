;; BluefinTecsEcr SDK EcrApi entity (generated by @voxgig/sdkgen).
(ns sdk.entity.ecr_api
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "ecr_api" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (EcrApi client data) accessor delegates here.
...
;; Load a single EcrApi (reqmatch: id/query fields; nil = empty match).
...
;; Create a new EcrApi (reqdata: body data).

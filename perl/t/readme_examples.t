#!perl
# BluefinTecsEcr SDK - documentation example COMPLETENESS gate.
#
...
#      (BluefinTecsEcrSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinTecsEcrSDK';
...
# becomes BluefinTecsEcrSDK->test(<fixtures>); a block that only uses $client gets

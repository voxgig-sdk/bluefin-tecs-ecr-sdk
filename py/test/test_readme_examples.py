# BluefinTecsEcr SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinTecsEcrSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinTecsEcrSDK(...) and BluefinTecsEcrSDK.test(...) become
#      BluefinTecsEcrSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefintecsecr_sdk"
_SDK_CLASS = "BluefinTecsEcrSDK"

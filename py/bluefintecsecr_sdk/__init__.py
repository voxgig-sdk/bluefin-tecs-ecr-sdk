...
from bluefintecsecr_sdk.utility import register

# Load features
from bluefintecsecr_sdk.feature.base_feature import BluefinTecsEcrBaseFeature
from bluefintecsecr_sdk.features import _has_feature, _make_feature
...
class BluefinTecsEcrSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BluefinTecsEcrUtility()
        self._utility = utility

        from bluefintecsecr_sdk.config import shared_config
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BluefinTecsEcrSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def EcrApi(self, data=None) -> "EcrApiEntity":
        """Entity factory: client.EcrApi().list() / client.EcrApi().load({"id": ...})."""
        from bluefintecsecr_sdk.entity.ecr_api_entity import EcrApiEntity
        return EcrApiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BluefinTecsEcrSDK":
        if sdkopts is None:
            sdkopts = {}

...
| `terminal_number` | `str` | Yes |  |
| `transaction_date_time` | `str` | Yes |  |
| `transaction_id` | `str` | Yes |  |
| `transaction_origin_identifier` | `str` | No |  |
| `transaction_origin_indicator` | `str` | No |  |
| `transaction_place` | `str` | No |  |
| `transaction_source_id` | `str` | No |  |

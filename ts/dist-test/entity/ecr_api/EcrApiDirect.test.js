...
(0, node_test_1.describe)('EcrApiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BluefinTecsEcrSDK({
    ...
    (0, node_test_1.test)('direct-load-ecr_api', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ecr_api', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BLUEFIN_TECS_ECR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BluefinTecsEcrSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
    ...
    const client = new __1.BluefinTecsEcrSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EcrApiDirect.test.js.map
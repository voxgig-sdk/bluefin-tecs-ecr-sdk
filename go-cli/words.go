...
func registerSDKWords(r *eng.Registry, client *sdk.BluefinTecsEcrSDK) {
...
func runOp(client *sdk.BluefinTecsEcrSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

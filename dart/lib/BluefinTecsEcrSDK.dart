...
import 'entity/EcrApiEntity.dart';


export 'BluefinTecsEcrTypes.dart';
export 'entity/EcrApiEntity.dart';
...
import 'Config.dart';
import 'Spec.dart';
// BluefinTecsEcrEntityBase / BluefinTecsEcrError / BaseFeature are re-exported below;
...
// `utility` (BluefinTecsEcrTypes.dart) — exporting both from this library makes
// the name ambiguous and NO dart SDK for such an API compiles:
//
//   Error: 'Utility' is exported from both 'lib/BluefinTecsEcrTypes.dart'
...
export 'BluefinTecsEcrEntityBase.dart' show BluefinTecsEcrEntityBase;
export 'BluefinTecsEcrError.dart' show BluefinTecsEcrError;
...
class BluefinTecsEcrSDK {
  ...
  BluefinTecsEcrSDK([dynamic options]) {
  ...
  dynamic _opDenied(String op) {
    ...
    return {
      'ok': false,
      'err': Exception('BluefinTecsEcrSDK: $op: operation not allowed by'
  ...
  Future<dynamic> graphql(String query,
    ...
    if (errors is List && 0 < errors.length) {
      ...
      res['ok'] = false;
      res['err'] = Exception('BluefinTecsEcrSDK: graphql: '
  ...
  // Entity access: `client.EcrApi().list()` / `client.EcrApi().load({'id': ...})`.
  EcrApiEntity EcrApi([dynamic entopts]) {
    return EcrApiEntity(this, entopts);
  }



  static BluefinTecsEcrSDK test([dynamic testoptsarg, dynamic sdkoptsarg]) {
    ...
    final testsdk = BluefinTecsEcrSDK(sdkopts);
    testsdk.mode = 'test';

    return testsdk;
  }

  BluefinTecsEcrSDK tester([dynamic testopts, dynamic sdkopts]) {
    return BluefinTecsEcrSDK.test(testopts, sdkopts);
  }

  Map<String, dynamic> toJSON() {
    return {'name': 'BluefinTecsEcr'};
  }

  @override
  String toString() {
    return 'BluefinTecsEcr ' + _utility.struct.jsonify(toJSON());
  }
}

typedef SDK = BluefinTecsEcrSDK;

...
import 'dart:async';
import '../utility/ErrUtility.dart';import '../BluefinTecsEcrEntityBase.dart';

// Typed models: see ../BluefinTecsEcrTypes.dart (EcrApi and the per-op request/match types).
class EcrApiEntity extends BluefinTecsEcrEntityBase {
  EcrApiEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'ecr_api';
    name_ = 'ecr_api';
    Name = 'EcrApi';
  }
  ...
  EcrApiEntity make() {
    return EcrApiEntity(client, entopts());
  }


  /// Load a EcrApi by match (see EcrApiLoadMatch in
  /// BluefinTecsEcrTypes.dart). Returns the entity data map (EcrApi).
  ...
  /// Create a EcrApi (see EcrApiCreateData in
  /// BluefinTecsEcrTypes.dart). Returns the entity data map (EcrApi).

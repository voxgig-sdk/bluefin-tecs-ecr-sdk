# BluefinTecsEcr JavaScript SDK



The JavaScript SDK for the BluefinTecsEcr API — an entity-oriented client with full async/await support.
...
bluefin-tecs-ecr/
├── src/
│   ├── BluefinTecsEcrSDK.js        # Main SDK class

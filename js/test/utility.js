...
function envOverride(m) {
  if (
    'TRUE' === process.env.BLUEFINTECSECR_TEST_LIVE ||
    'TRUE' === process.env.BLUEFINTECSECR_TEST_OVERRIDE
  ) {
  ...
  m.BLUEFINTECSECR_TEST_EXPLAIN = process.env.BLUEFINTECSECR_TEST_EXPLAIN || m.BLUEFINTECSECR_TEST_EXPLAIN

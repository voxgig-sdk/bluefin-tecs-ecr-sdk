...
describe("EcrApiDirect", function()
  it("should direct-load-ecr_api", function()
    local setup = ecr_api_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ecr_api", setup.live and "live" or "unit")

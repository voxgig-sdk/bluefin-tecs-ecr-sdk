...
local EcrApiEntity = {}
EcrApiEntity.__index = EcrApiEntity


function EcrApiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EcrApiEntity)
  self._name = "ecr_api"
  self._client = client
...
function EcrApiEntity:get_name()
  return self._name
end


function EcrApiEntity:make()
  local opts = {}
...
function EcrApiEntity:mark_deleted()
  self._deleted = true
end


function EcrApiEntity:deleted()
  return true == self._deleted
end


function EcrApiEntity:data_set(args)
  if args ~= nil then
...
function EcrApiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EcrApiEntity:match_set(args)
  if args ~= nil then
...
function EcrApiEntity:match_get()
...
function EcrApiEntity:stream(action, args, callopts)
...
---@param reqmatch EcrApiLoadMatch
---@param ctrl? table
---@return EcrApi
---@return string? err
function EcrApiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata EcrApiCreateData
---@param ctrl? table
---@return EcrApi
---@return string? err
function EcrApiEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function EcrApiEntity:_run_op(ctx, post_done)
  local utility = self._utility

// BluefinTecsEcr SDK — umbrella runtime header (template; BluefinTecsEcr tokens
...
#ifndef BLUEFINTECSECR_SDK_H
#define BLUEFINTECSECR_SDK_H
...
typedef struct BluefinTecsEcrSDK BluefinTecsEcrSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinTecsEcrError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinTecsEcr"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinTecsEcrEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinTecsEcrEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinTecsEcrSDK) — generic fields.
// ===========================================================================

struct BluefinTecsEcrSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinTecsEcrSDK* sdk, Feature* f);
void sdk_features_insert(BluefinTecsEcrSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinTecsEcrSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinTecsEcrSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinTecsEcrSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinTecsEcrSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
BluefinTecsEcrSDK* bluefintecsecr_sdk_new(voxgig_value* options);
BluefinTecsEcrSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(BluefinTecsEcrSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(BluefinTecsEcrSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(BluefinTecsEcrSDK* sdk, const char* query,

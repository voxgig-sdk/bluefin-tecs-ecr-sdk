// Behavioural feature-test harness for the BluefinTecsEcr SDK (C port of the
...
#ifndef BLUEFINTECSECR_FEATURE_HARNESS_H
#define BLUEFINTECSECR_FEATURE_HARNESS_H
...
#endif // BLUEFINTECSECR_FEATURE_HARNESS_H

...
static void test_primary_fetcher_live(void) {
  ...
  BluefinTecsEcrSDK* live = bluefintecsecr_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinTecsEcrSDK* blocked = bluefintecsecr_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinTecsEcrSDK* client = bluefintecsecr_sdk_new(v_undef());

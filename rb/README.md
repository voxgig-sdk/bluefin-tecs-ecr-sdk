# BluefinTecsEcr Ruby SDK



The Ruby SDK for the BluefinTecsEcr API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `BluefinTecsEcrError` (a `StandardError` subclass), so wrap
...
```
rb/
├── BluefinTecsEcr_sdk.rb       -- Main SDK module

...
require_relative 'BluefinTecsEcr_types'
...
class BluefinTecsEcrSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = BluefinTecsEcrHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = BluefinTecsEcrHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, BluefinTecsEcrFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    BluefinTecsEcrUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = BluefinTecsEcrHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = BluefinTecsEcrHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = BluefinTecsEcrHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue BluefinTecsEcrError => err
    ...
    if fetched.is_a?(Hash)
      status = BluefinTecsEcrHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = BluefinTecsEcrError.new(
        "graphql_error", "BluefinTecsEcrSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  # Canonical facade: client.EcrApi.list / client.EcrApi.load({ "id" => ... })
  def EcrApi(data = nil)
    require_relative 'entity/ecr_api_entity'
    EcrApiEntity.new(self, data)
  end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = BluefinTecsEcrSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end

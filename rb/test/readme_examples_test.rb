...
#      offline in seeded test mode (BluefinTecsEcrSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinTecsEcr_sdk.rb")
  SDK_CLASS = "BluefinTecsEcrSDK"

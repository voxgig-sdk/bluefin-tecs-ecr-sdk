...
import voxgig.bluefintecsecrsdk.core.{Context, Helpers, SdkClient, SdkEntity, Utility}
import voxgig.bluefintecsecrsdk.utility.struct.Struct

// Shared entity runtime for the BluefinTecsEcr SDK: accreting data/match state,

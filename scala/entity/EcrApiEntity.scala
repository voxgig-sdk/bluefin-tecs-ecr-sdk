...
import voxgig.bluefintecsecrsdk.core.{Context, Entity, Helpers, SdkClient}
import voxgig.bluefintecsecrsdk.utility.struct.Struct

// EcrApi entity client for the BluefinTecsEcr SDK.
class EcrApiEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("ecr_api", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new EcrApiEntity(this.client, opts)
  }

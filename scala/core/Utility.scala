...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefintecsecrsdk.utility.StructUtility.type = voxgig.bluefintecsecrsdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefintecsecrsdk.utility.Register.registerAll(this)
  }

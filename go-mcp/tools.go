...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ecr_api"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BluefinTecsEcrSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bluefin-tecs-ecr_list",
		Description: "List records from BluefinTecsEcr. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bluefin-tecs-ecr_load",
		Description: "Load a single record from BluefinTecsEcr. " +
...
func runOp(client *sdk.BluefinTecsEcrSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BluefinTecsEcrSDK, name string) (sdk.BluefinTecsEcrEntity, error) {
	switch strings.ToLower(name) {
	case "ecr_api":
		return client.EcrApi(nil), nil

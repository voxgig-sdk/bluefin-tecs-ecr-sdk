// Command BluefinTecsEcr-mcp is an MCP server exposing the BluefinTecsEcr
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinTecsEcr_list  — list records of an entity
//	BluefinTecsEcr_load  — load a single record of an entity
//

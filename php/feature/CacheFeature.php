...
// BluefinTecsEcr SDK cache feature
...
class BluefinTecsEcrCacheFeature extends BluefinTecsEcrBaseFeature
{
    ...
    private function _through(BluefinTecsEcrContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// BluefinTecsEcr SDK rbac feature
...
class BluefinTecsEcrRbacFeature extends BluefinTecsEcrBaseFeature
{
    ...
    private function _required(BluefinTecsEcrContext $ctx): ?string
    {
    ...
    private function _reject(BluefinTecsEcrContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinTecsEcrContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

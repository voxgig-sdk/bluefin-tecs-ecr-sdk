...
// BluefinTecsEcr SDK audit feature
...
class BluefinTecsEcrAuditFeature extends BluefinTecsEcrBaseFeature
{
    ...
    private function _emit(BluefinTecsEcrContext $ctx, string $outcome): void
    {

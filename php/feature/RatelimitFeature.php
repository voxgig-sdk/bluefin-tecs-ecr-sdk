...
// BluefinTecsEcr SDK ratelimit feature
...
class BluefinTecsEcrRatelimitFeature extends BluefinTecsEcrBaseFeature
{
    ...
    private function _acquire(BluefinTecsEcrContext $ctx): void
    {
    ...
    private function _track(BluefinTecsEcrContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

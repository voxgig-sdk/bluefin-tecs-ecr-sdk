...
class BluefinTecsEcrTestFeature extends BluefinTecsEcrBaseFeature
{
    ...
    public function init(BluefinTecsEcrContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BluefinTecsEcrContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BluefinTecsEcrParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BluefinTecsEcrContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BluefinTecsEcrContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = BluefinTecsEcrParam::call($ctx, $k);

...
class BluefinTecsEcrPagingFeature extends BluefinTecsEcrBaseFeature
{
    ...
    private function _graphql_pre_request(BluefinTecsEcrContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BluefinTecsEcrContext $ctx): bool
    {

...
// BluefinTecsEcr SDK proxy feature
...
class BluefinTecsEcrProxyFeature extends BluefinTecsEcrBaseFeature
{
    ...
    public function init(BluefinTecsEcrContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinTecsEcrContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

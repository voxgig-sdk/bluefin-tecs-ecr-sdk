...
// BluefinTecsEcr SDK utility type

class BluefinTecsEcrUtility
{
    ...
    public static function copy(BluefinTecsEcrUtility $src): BluefinTecsEcrUtility
    {
        $u = new BluefinTecsEcrUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

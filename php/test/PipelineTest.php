...
// BluefinTecsEcr SDK pipeline test
//
...
{
    private static function utility(): BluefinTecsEcrUtility
    {
        return new BluefinTecsEcrUtility();
    }
    ...
    private static function ctx(array $over = []): BluefinTecsEcrContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BluefinTecsEcrContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BluefinTecsEcrOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BluefinTecsEcrError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BluefinTecsEcrOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BluefinTecsEcrMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BluefinTecsEcrOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BluefinTecsEcrMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BluefinTecsEcrOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BluefinTecsEcrMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinTecsEcrSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BluefinTecsEcrMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BluefinTecsEcrResponse([]),
            'result' => new BluefinTecsEcrResult([]),
        ]);
        [, $err] = BluefinTecsEcrMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BluefinTecsEcrSpec([]),
            'response' => null,
            'result' => new BluefinTecsEcrResult([]),
        ]);
        [, $err] = BluefinTecsEcrMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsEcrSpec(['step' => 's']),
            'response' => new BluefinTecsEcrResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BluefinTecsEcrResult([]),
        ]);
        [, $err] = BluefinTecsEcrMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsEcrSpec(['step' => 's']),
            'response' => new BluefinTecsEcrResponse(self::resp(200, ['v' => 1])),
            'result' => new BluefinTecsEcrResult([]),
        ]);
        [, $err] = BluefinTecsEcrMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsEcrSpec(['step' => 's']),
            'response' => new BluefinTecsEcrResponse(self::resp(200, ['v' => 2])),
            'result' => new BluefinTecsEcrResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsEcrMakeResponse::call($ctx);
    ...
    {
        $preset = new BluefinTecsEcrResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BluefinTecsEcrSpec([]),
            'response' => new BluefinTecsEcrResponse([]),
            'result' => new BluefinTecsEcrResult([]),
        ...
        [$got, $err] = BluefinTecsEcrMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BluefinTecsEcrResult([])]);
        [, $err] = BluefinTecsEcrMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BluefinTecsEcrSpec([]), 'result' => null]);
        [, $err] = BluefinTecsEcrMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinTecsEcrSpec(['step' => 's']),
            'result' => new BluefinTecsEcrResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BluefinTecsEcrOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinTecsEcrMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinTecsEcrSpec(['step' => 's']),
            'result' => new BluefinTecsEcrResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BluefinTecsEcrOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinTecsEcrMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinTecsEcrResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BluefinTecsEcrSpec([]),
            'result' => new BluefinTecsEcrResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BluefinTecsEcrMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinTecsEcrMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BluefinTecsEcrError('boom', 'boom');
        $utility->fetcher = function (BluefinTecsEcrContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinTecsEcrSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BluefinTecsEcrMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BluefinTecsEcrContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BluefinTecsEcrMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BluefinTecsEcrResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsEcrMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BluefinTecsEcrContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinTecsEcrSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BluefinTecsEcrMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BluefinTecsEcrResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BluefinTecsEcrSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BluefinTecsEcrMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BluefinTecsEcrMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BluefinTecsEcrMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BluefinTecsEcrResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BluefinTecsEcrDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BluefinTecsEcrResult(['ok' => false])]);
        $this->expectException(BluefinTecsEcrError::class);
        BluefinTecsEcrDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BluefinTecsEcrResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BluefinTecsEcrMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsEcrMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BluefinTecsEcrBaseFeature();
        $b = new BluefinTecsEcrBaseFeature();
        BluefinTecsEcrFeatureAdd::call($ctx, $a);
        BluefinTecsEcrFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BluefinTecsEcrBaseFeature
    {
        $f = new BluefinTecsEcrBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BluefinTecsEcrFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BluefinTecsEcrContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BluefinTecsEcrSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinTecsEcrPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BluefinTecsEcrPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BluefinTecsEcrResponse(['headers' => null]),
            'result' => new BluefinTecsEcrResult([]),
        ]);
        BluefinTecsEcrResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BluefinTecsEcrResultBody::call($ctx);

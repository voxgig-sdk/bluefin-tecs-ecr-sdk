...
// BluefinTecsEcr SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BluefinTecsEcrOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BluefinTecsEcrOmni::structfix($now, Struct::undef()))
                        !== json_encode(BluefinTecsEcrOmni::structfix($val, Struct::undef()))) {

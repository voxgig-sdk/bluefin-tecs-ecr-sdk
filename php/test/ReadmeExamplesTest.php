...
//      EXECUTED offline in seeded test mode (BluefinTecsEcrSDK::test)
...
{
    private const SDK_CLASS = 'BluefinTecsEcrSDK';
    ...
    private const SDK_BASE = 'bluefintecsecr_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bluefintecsecr_sdk.php';

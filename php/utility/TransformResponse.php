...
// BluefinTecsEcr SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BluefinTecsEcrTransformResponse
{
    public static function call(BluefinTecsEcrContext $ctx): mixed
    {
        ...
        $transform = BluefinTecsEcrHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

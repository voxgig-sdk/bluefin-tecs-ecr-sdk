# EcrApi direct test (offline, mock system.fetch)

defmodule BluefinTecsEcr.EcrApiDirectTest do
  use ExUnit.Case
  ...
  defp mk(canned) do
    ...
    BluefinTecsEcr.new(S.jm(["base", "http://localhost:8080", "system", S.jm(["fetch", fetch])]))
  end

  test "should direct load ecr_api" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinTecsEcr.direct(sdk, H.deep(%{"path" => "/ecr_api/direct01", "method" => "GET", "params" => %{}}))

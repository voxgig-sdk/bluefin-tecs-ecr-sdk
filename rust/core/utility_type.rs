...
impl Utility {
    ...
    pub fn done(&self, ctx: &Rc<Context>) -> Result<Value, BluefinTecsEcrError> {
    ...
    pub fn make_error(
        &self,
        ctx: &Rc<Context>,
        err: Option<BluefinTecsEcrError>,
    ) -> Result<Value, BluefinTecsEcrError> {
    ...
    pub fn make_fetch_def(&self, ctx: &Rc<Context>) -> Result<Value, BluefinTecsEcrError> {
    ...
    pub fn make_request(
        &self,
        ctx: &Rc<Context>,
    ) -> Result<Rc<RefCell<Response>>, BluefinTecsEcrError> {
    ...
    pub fn make_result(
        &self,
        ctx: &Rc<Context>,
    ) -> Result<Rc<RefCell<SdkResult>>, BluefinTecsEcrError> {
        u::make_result::make_result_util(ctx)
    }

    pub fn make_point(&self, ctx: &Rc<Context>) -> Result<Value, BluefinTecsEcrError> {
        u::make_point::make_point_util(ctx)
    }

    pub fn make_spec(&self, ctx: &Rc<Context>) -> Result<Rc<RefCell<Spec>>, BluefinTecsEcrError> {
        u::make_spec::make_spec_util(ctx)
    }

    pub fn make_url(&self, ctx: &Rc<Context>) -> Result<String, BluefinTecsEcrError> {
    ...
    pub fn prepare_auth(&self, ctx: &Rc<Context>) -> Result<Rc<RefCell<Spec>>, BluefinTecsEcrError> {

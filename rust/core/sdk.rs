// BluefinTecsEcrSDK client (generated — mirrors the go Main fragment).
...
impl BluefinTecsEcrSDK {
    pub fn new(options: Value) -> Rc<BluefinTecsEcrSDK> {
        let sdk = Rc::new(BluefinTecsEcrSDK {
    ...
    pub fn prepare(&self, fetchargs: Value) -> Result<Value, BluefinTecsEcrError> {
    ...
    pub fn direct(&self, fetchargs: Value) -> Result<Value, BluefinTecsEcrError> {
    ...
    fn op_denied(&self, op: &str) -> Value {
        ...
        jo(vec![
            ...
            ("err", Value::str(format!(
                "BluefinTecsEcrSDK: {}: operation not allowed by SDK option \
    ...
    // gate by passing it.
    fn raw_request(&self, fetchargs: Value) -> Result<Value, BluefinTecsEcrError> {
        let utility = &self.utility;
    ...
    pub fn graphql(
        ...
        if let Value::List(items) = &errors {
            ...
            if let Some(first) = first {
                ...
                setp(&res, "err",
                     Value::str(format!("BluefinTecsEcrSDK: graphql: {}", msg)));
    ...
    pub fn ecr_api(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::ecr_api::EcrApiEntity> {
        crate::entity::ecr_api::EcrApiEntity::new(self, entopts)
    }

}

pub fn test_sdk(testopts: Value, sdkopts: Value) -> Rc<BluefinTecsEcrSDK> {
    ...
    let sdk = BluefinTecsEcrSDK::new(sdkopts);
    *sdk.mode.borrow_mut() = "test".to_string();

// BluefinTecsEcr SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinTecsEcrError;
...
pub use crate::core::sdk::{test_sdk, BluefinTecsEcrSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinTecsEcrEntity,
};
...
// No-argument convenience constructors: `bluefin_tecs_ecr_sdk::new()` /
// `bluefin_tecs_ecr_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinTecsEcrSDK> {
    BluefinTecsEcrSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinTecsEcrSDK> {

// EcrApi entity client (generated — mirrors the go Entity fragment).
...
use crate::core::error::BluefinTecsEcrError;
use crate::core::helpers::{get_bool, getp, setp, to_map};
use crate::core::sdk::BluefinTecsEcrSDK;
use crate::core::types::{Entity, BluefinTecsEcrEntity};
use crate::core::utility_type::Utility;
use crate::utility::voxgigstruct as vs;
use crate::utility::voxgigstruct::Value;

pub struct EcrApiEntity {
    name: String,
    #[allow(dead_code)]
...
impl EcrApiEntity {
    pub fn new(client: &Rc<BluefinTecsEcrSDK>, entopts: Value) -> Rc<EcrApiEntity> {
        ...
        let e = Rc::new(EcrApiEntity {
            name: "ecr_api".to_string(),
            client: client.clone(),
    ...
    ) -> Result<Value, BluefinTecsEcrError> {
    ...
    pub fn stream(
        ...
        args: Value,
        callopts: Value,
    ) -> Result<std::vec::IntoIter<Value>, BluefinTecsEcrError> {
...
impl Entity for EcrApiEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        EcrApiEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsEcrEntity for EcrApiEntity {

    fn load(self: &Rc<Self>, reqmatch: Value, ctrl: Value) -> Result<Rc<Self>, BluefinTecsEcrError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn list(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Vec<Rc<Self>>, BluefinTecsEcrError> {
        Err(crate::core::helpers::unsupported_op("list", &self.name))
    }


    fn create(self: &Rc<Self>, reqdata: Value, ctrl: Value) -> Result<Rc<Self>, BluefinTecsEcrError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn update(self: &Rc<Self>, _reqdata: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsEcrError> {
        Err(crate::core::helpers::unsupported_op("update", &self.name))
    }

    fn remove(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsEcrError> {

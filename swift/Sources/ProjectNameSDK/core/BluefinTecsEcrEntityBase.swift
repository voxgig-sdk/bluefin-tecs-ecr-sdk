// BluefinTecsEcrEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinTecsEcrEntityBase: Entity {
  var name: String
  var client: BluefinTecsEcrSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinTecsEcrSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinTecsEcrEntityBase(client, cloneOpts(), name)
  }

// ecr_api direct API test (generated from the API model).

import XCTest

@testable import BluefinTecsEcrSdk

final class EcrApiDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinTecsEcrSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/ecr_api")

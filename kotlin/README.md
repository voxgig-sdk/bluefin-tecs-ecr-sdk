# BluefinTecsEcr Kotlin SDK



The Kotlin SDK for the BluefinTecsEcr API — an entity-oriented client following idiomatic Kotlin conventions.
...
release tag (`kotlin/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/bluefin-tecs-ecr-sdk/releases)) or
...
| `payment_reasonAsByte` | `List<Any?>?` | Payment reason represented as a byte array. |
...
```kotlin
val ecrApi = client.ecrApi(null).create(mutableMapOf<String, Any?>(
...
`MutableMap<String, Any?>`. A `BluefinTecsEcrTypes.kt` module of

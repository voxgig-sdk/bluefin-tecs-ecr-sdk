...
object RunnerSupport {
  ...
  fun envOverride(m: MutableMap<String, Any?>): MutableMap<String, Any?> {
    if ("TRUE" == getenv("BLUEFIN_TECS_ECR_TEST_LIVE") || "TRUE" == getenv("BLUEFIN_TECS_ECR_TEST_OVERRIDE")) {
    ...
    val explain = getenv("BLUEFIN_TECS_ECR_TEST_EXPLAIN")
  ...
  class EntityTestSetup {
    lateinit var client: BluefinTecsEcrSDK
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: BluefinTecsEcrSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: BluefinTecsEcrSDK?) {

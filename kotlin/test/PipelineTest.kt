...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinTecsEcrSDK {
    return BluefinTecsEcrSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinTecsEcrSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinTecsEcrSDK): String {

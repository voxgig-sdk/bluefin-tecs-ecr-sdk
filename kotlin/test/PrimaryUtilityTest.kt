...
import voxgig.bluefintecsecrsdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefintecsecrsdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefintecsecrsdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefintecsecrsdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinTecsEcrSDK = BluefinTecsEcrSDK.testSDK()

  private fun makeTestCtx(client: BluefinTecsEcrSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinTecsEcrSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinTecsEcrSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinTecsEcrSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinTecsEcrSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinTecsEcrSDK.testSDK(null, setupOpts)

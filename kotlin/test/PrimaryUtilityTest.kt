...
class PrimaryUtilityTest {
  ...
  companion object {
    ...
    private var CLIENT: BluefinTecsEcrSDK? = null
    ...
    fun run(): OmniResolver.Run {
      var r = RUN
      if (null == r) {
        val client = BluefinTecsEcrSDK.testSDK()
        CLIENT = client
  ...
  fun featureHookBasic() {
    val hookClient = BluefinTecsEcrSDK.testSDK()
  ...
  fun featureInitBasic() {
    val initClient = BluefinTecsEcrSDK.testSDK()

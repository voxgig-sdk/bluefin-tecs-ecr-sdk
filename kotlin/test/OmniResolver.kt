...
object OmniResolver {
   ...
   */
  fun makeRunner(testfile: Any?, client: BluefinTecsEcrSDK?): NamedRunner {
  ...
  private fun sdkProvider(client: BluefinTecsEcrSDK?): Provider = Provider(
    ...
    client = { options ->
      ...
      sdkProvider(BluefinTecsEcrSDK.testSDK(null, opts ?: linkedMapOf()))
    },
   ...
   * per section, by hand.)
   */
  fun omniCtx(arg: Any?, client: BluefinTecsEcrSDK?, utility: Utility?): Context {

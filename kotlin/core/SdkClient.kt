...
/**
 * Shared client runtime for the BluefinTecsEcr SDK. The generated
 * BluefinTecsEcrSDK class extends this with the API-specific entity accessors;
  ...
  fun graphql(
    ...
    if (null != errors && errors.isNotEmpty()) {
      ...
      res["err"] = SdkError("graphql_error",
        "BluefinTecsEcrSDK: graphql: " + msg, null)
      res["graphql"] = errors
    }

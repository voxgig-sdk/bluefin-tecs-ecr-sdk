...
fun resultBasic(ctx: Context): voxgig.bluefintecsecrsdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefintecsecrsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefintecsecrsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
